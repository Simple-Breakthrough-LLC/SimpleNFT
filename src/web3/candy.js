...
/*
// https://github.com/metaplex-foundation/metaplex-program-library/blob/master/candy-machine/program/src/processor/add_config_lines.rs
const addConfigLinesInstruction = async (connection, accounts, candyData) => {
